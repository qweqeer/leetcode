...
//stream/ 
// Related Topics 设计 双指针 数据流 排序 堆（优先队列） 👍 314 👎 0

package leetcode.editor.cn;

import java.util.PriorityQueue;

public class P41_ShuJuLiuZhongDeZhongWeiShuLcof {
    public static void main(String[] args) {
        //测试代码
        MedianFinder solution = new P41_ShuJuLiuZhongDeZhongWeiShuLcof().new MedianFinder();
        solution.addNum(-1);
        solution.addNum(-2);
